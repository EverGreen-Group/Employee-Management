        ...
        <table>
            ...
            <?php foreach ($tasks as $task): ?>
                <tr>
                    ...
                    <td>
                        <form action="/update-task-status" method="POST" class="status-form" id="status-form-<?= $task['id'] ?>">
                            <input type="hidden" name="task_id" value="<?= $task['id'] ?>">
                            <select name="new_status" class="status <?= strtolower($task['status']) ?>">
                    ...
                    <td>
                        <button class="status-btn" onclick="updateTaskStatus(<?= $task['id'] ?>)">
